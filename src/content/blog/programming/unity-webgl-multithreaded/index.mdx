...
## Part 2
Part two, featuring cross-platform implementation that shares the same code as WebGL, found here:
https://kyouha.today/blog/programming/unity-webgl-multithreaded-part2
...
### Example repo
All the code can be found here: https://github.com/Timiz0r/WebGLMultiThreaded/tree/original
